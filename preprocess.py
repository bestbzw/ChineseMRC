...
def lic2020_convert_example_to_features_init(tokenizer_for_convert):
    global tokenizer
...
class Lic2020Processor(DataProcessor):
    """
    Processor for the Lic2020 MRC data set.
    """
...
class Lic2020Example(object):
    ...
    def __init__(
        ...
        #doc_tokens = list(self.context_text)
        #char_to_word_offset = range(len(doc_tokens))
