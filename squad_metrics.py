...
def _compute_softmax(scores):
    ...
    return probs
def compute_predictions_logits_and_output_all_logits(
    all_examples,
    all_features,
    all_results,
    n_best_size,
    ...
    all_logits_result = collections.OrderedDict()
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        for (feature_index, feature) in enumerate(features):
            ...
            for index,logit in enumerate(result.start_logits): 
                if feature.token_is_max_context.get(index, False):
                    all_start_logit[feature.token_to_all_tokens_map[index]] = (feature.token_to_orig_map[index],feature.tokens[index],logit)
